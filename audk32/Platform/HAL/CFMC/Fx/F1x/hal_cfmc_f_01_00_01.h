/**
 *******************************************************************************
 * @file        hal_cfmc_f_01_00_01.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.01 typed CFMC
 *
...
#ifndef _HAL_CFMC_F_01_00_01_H_
#define _HAL_CFMC_F_01_00_01_H_
...
#define CFMC_CR_PAGE_ERS_CMD                          (CFMC_CR_WKY_RST_PE | 0x00000001)
#define CFMC_CR_SECTOR_ERS_CMD                        (CFMC_CR_WKY_RST_PE | 0x00000002)
#define CFMC_CR_PAGE_PGM_CMD                          (CFMC_CR_WKY_RST_PE | 0x00000004)
#define CFMC_CR_CHIP_ERS_CMD                          (CFMC_CR_WKY_RST_PE | 0x00000010)
...
#define CFMC_BCR_SYSFLASH_WPROT                       (CFMC_BCR_WKY_SYSFLASH_WPROT | 0x5000)

/* Suedo registers */
#define CFMC_SEUDO_RPROTR                             0x1FFF3000UL
#define CFMC_SEUDO_WDT_CFGR                           0x1FFF300CUL
#define CFMC_SEUDO_LVRST_CFGR                         0x1FFF3010UL
#define CFMC_SEUDO_CFGOPT_WPROTR                      0x1FFF3014UL
#define CFMC_SEUDO_WPROTR                             0x1FFF3040UL
...
#define CFMC_VARIANT_FEATURE_PAGE_SIZE                0x00000200UL
...
#define SET_SCU_FMC_RST(Peri,Data)                    SET_BIT(Peri,Data,SCUCG,PPRST2,FMCRST)
...
#define GET_CFMC_DR_BUF_ADDR(Peri)                    (void)Peri
...
RAMFUNC static __inline void CFMC_SetConfig(CFMC_CONFIG_t tConfig)
{
    ...
    SET_SCU_FMC_RST(((SCUCG_Type*)SCUCG_BASE), true);
    SET_SCU_FMC_RST(((SCUCG_Type*)SCUCG_BASE), false);
...
RAMFUNC static __inline void CFMC_Erase (volatile uint32_t un32PageAddr, CFMC_ERASE_MODE_e eEraseMode, bool bIsSystemFlash)
{
    ...
    uint32_t *pun32PageBuf = (uint32_t *)un32PageAddr;
    ...
    else if ((eEraseMode == CFMC_PAGE_ERASE_MODE) || (eEraseMode == CFMC_2KB_ERASE_MODE))
    {
        ...
        if (eEraseMode == CFMC_PAGE_ERASE_MODE)
        {
            un32EraseCmd  = CFMC_CR_PAGE_ERS_CMD;
        }
        else
        {
            un32EraseCmd  = CFMC_CR_SECTOR_ERS_CMD;
        }
    }
    else
    {
    ...
    /* Fire Erase Command */
    SET_CFMC_CR(ptRegBase, un32SelectedFlash | un32EraseCmd);
