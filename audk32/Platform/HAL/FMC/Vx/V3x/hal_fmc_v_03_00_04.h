/**
 *******************************************************************************
 * @file        hal_fmc_v_03_00_04.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 03.00.04 typed FMC
 *
...
#ifndef _HAL_FMC_V_03_00_04_H_
#define _HAL_FMC_V_03_00_04_H_
...
#define FMC_FEATURE_RUMTIME_READ_PROTECTION           0
...
#define FMC_STATUS_ERROR_Mask                         0x007F0000
...
#define SET_FMC_CR_FLASH_LOCK(Peri,Data)              (Peri->CTRL = (Data > 0)? ((Peri->CTRL & ~CFMC_CTRL_FLOCK_Msk) \
                                                        | 0x80000000) : (Peri->CTRL & ~CFMC_CTRL_FLOCK_Msk))
#define SET_FMC_CR_SYSFLASH_LOCK(Peri,Data)           SET_BIT(Peri,Data,CFMC,CTRL,INFOLOCK)
