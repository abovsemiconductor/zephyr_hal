/**
 *******************************************************************************
 * @file        hal_led_v_01_00_01.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.01 typed LED
 *
...
#ifndef _HAL_LED_V_01_00_01_H_
#define _HAL_LED_V_01_00_01_H_
...
#define GET_LED_DIMMING_BASE_ADDR(Peri)               GET_REG_ADDR(Peri,DIMM1)
#define SET_LED_DR_DIMMING(Addr,Id,Data)              SET_BIT_ADDR_DATA_OFFSET(Addr,LED_DIMM_ADDR_OFFSET(Id),LED_DIMM_DATA_OFFSET(Id),Data,LED,DIMM1,COMDIMM0)
...
/* Unused Macro */
#define SET_LED_CON2_COMSEG(Peri,Data)                (void)Peri
