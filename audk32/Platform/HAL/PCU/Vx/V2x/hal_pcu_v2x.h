...
static __inline LVINER_Type *PCU_LVINER_GetReg(uint32_t un32Id)
{
    return (LVINER_Type *) PCU_LVINER_BASE;
}
#endif

#if defined(PCU_FEATURE_SUPPORT_OPENDRAIN)
static __inline AFODCR_Type *PCU_AFODCR_GetReg(uint32_t un32Id)
{
    return (AFODCR_Type *) PCU_AFODCR_BASE;
}
#endif
