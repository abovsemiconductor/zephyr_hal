/**
 *******************************************************************************
 * @file        startup_a31c14x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A31C14x
 *
...
#ifndef _STARTUP_A31C14X_H_
#define _STARTUP_A31C14X_H_
...
{
    if(CHIPCONFIG->CHIPID == 0x43311440)
    {
        return (int8_t *)"A31C144 : Code Flash 128KB / SRAM 8KB";
    }
    else if (CHIPCONFIG->CHIPID == 0x43311430)
    {
        return (int8_t *)"A31C143 : Code Flash 64KB / SRAM 8KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
static __inline void PRV_PORT_Init(void)
{
    ...
    SCU->PER1 |= 0x00UL
            | (0x01UL << SCU_PER1_GPIOF_Pos)    /* GPIO E */
            | (0x01UL << SCU_PER1_GPIOE_Pos)    /* GPIO F */
    ...
    PA->MR1 = 0x00UL
              ...
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5 - 0:PA5 1:     2:T6IO 3:     4:      7:AN5/CP1A */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4 - 0:PA4 1:     2:     3:T0IO 4:      7:AN4/CPB */
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3 - 0:PA3 1:     2:     3:     4:      7:AN3/CP0A */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2 - 0:PA2 1:     2:T6IO 3:     4:      7:AN2/CPRE0 */
              | (0x00UL << PCU_MR1_P1MUX_Pos)    /* P1 - 0:PA1 1:SCL1 2:     3:     4:      7:AN1 */
              | (0x00UL << PCU_MR1_P0MUX_Pos);   /* P0 - 0:PA0 1:SDA1 2:     3:     4:      7:AN0 */

    PA->MR2 = 0x00UL
              | (0x00UL << PCU_MR2_P11MUX_Pos)   /* P11 - 0:     1:      2:     3:     4: 7:     */
              | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:     1:      2:     3:     4: 7:AN13 */
              | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:     1:      2:     3:     4: 7:AN12 */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:     1:      2:     3:     4: 7:AN11 */
    ...
    PB->MR2 = 0x00UL
              | (0x00UL << PCU_MR2_P11MUX_Pos)   /* P9 - 0:PB11 1:      2:T8IO 3:      4:      7: */
              | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P9 - 0:PB10 1:      2:T9IO 3:      4:      7: */
              | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9 - 0:PB9  1:      2:T8IO 3:      4:      7: */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8 - 0:PB8  1:      2:T9IO 3:      4:      7: */

    PB->CR = 0xFFFFFFFFUL
              & ~(0x03UL << PCU_CR_P5_Pos)       /* P5 - 0:PB5 1:RXD0   2:     3:SWDIO    4:       7:*/
              & ~(0x03UL << PCU_CR_P4_Pos)       /* P4 - 0:PB4 1:TXD0   2:     3:SWCLK    4:       7:*/
              & ~(0x03UL << PCU_CR_P3_Pos);      /* P3 - 0:PB3 1:       2:     3:nBOOT    4:SS10   7:*/
    ...
    PC->MR2 = 0x00UL
              | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10- 0:PC10 1:     2: 3:SS11   4:   7: */
              | (0x03UL << PCU_MR2_P9MUX_Pos)    /* P9 - 0:PC9  1:     2: 3:nRESET   4:   7: */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8 - 0:PC8  1:     2: 3:         4:   7: */

    PC->CR = 0xFFFFFFFFUL
              & ~(0x03UL << PCU_CR_P9_Pos);       /* P9 - 0:PC9 1:     2: 3:nRESET   4:   7: */
    ...
    PD->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7 - 0:PD7 1:      2:T0IO 3: 4:       7: */
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6 - 0:PD6 1:      2:T1IO 3: 4:       7: */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5 - 0:PD5 1:      2:     3: 4:SS11   7: */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4 - 0:PD4 1:      2:     3: 4:SCK11  7: */
    ...
    PE->MR2 = 0x00UL
              | (0x00UL << PCU_MR2_P11MUX_Pos)   /* P11 - 0:PE11 1:      2:     3:      4:SS12   7: */
              | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:PE10 1:      2:     3:      4:SCK12  7: */
              | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PE9  1:RXD12 2:     3:      4:MISO12 7: */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PE8  1:TXD12 2:     3:      4:MOSI12 7: */
    ...
    PF->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7 - 0:PF7 1:     2:T4IO 3:     4:   7:      */
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6 - 0:PF6 1:     2:T3IO 3:     4:   7:      */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5 - 0:PF5 1:     2:T2IO 3:     4:   7:      */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4 - 0:PF4 1:     2:     3:CLKO 4:   7:      */
              | (0x07UL << PCU_MR1_P3MUX_Pos)    /* P3 - 0:PF3 1:     2:     3:     4:   7:SXOUT */
