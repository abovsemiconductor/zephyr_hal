/**
 *******************************************************************************
 * @file        startup_a31c15x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A31C15x
 *
...
#ifndef _STARTUP_A31C15X_H_
#define _STARTUP_A31C15X_H_
...
{
    if(CHIPCONFIG->CHIPID == 0x43311560)
    {
        return (int8_t *)"A31C156 : Code Flash 256KB / Data Flash 32KB / SRAM 32KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x43311561)
    {
        return (int8_t *)"A31C154 : Code Flash 128KB / Data Flash 32KB / SRAM 32KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
static __inline void PRV_PORT_Init(void)
{
    ...
    PA->MR1 = 0x00UL
              ...
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6  - 0:PA6  1:       2:       3:          4:       7:AN6/CPRE1 */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5  - 0:PA5  1:TXD10  2:T6IO   3:          4:MOSI10 7:AN5/CP1A */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4  - 0:PA4  1:RXD10  2:       3:          4:MISO10 7:AN4/CPB */
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3  - 0:PA3  1:       2:       3:          4:SCK10  7:AN3/CP0A */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2  - 0:PA2  1:       2:T6IO   3:          4:SS10   7:AN2/CPRE0 */
              | (0x00UL << PCU_MR1_P1MUX_Pos)    /* P1  - 0:PA1  1:SCL1   2:       3:          4:       7:AN1 */
              | (0x00UL << PCU_MR1_P0MUX_Pos);   /* P0  - 0:PA0  1:SDA1   2:       3:          4:       7:AN0 */

    PA->MR2 = 0x00UL
              | (0x00UL << PCU_MR2_P11MUX_Pos)   /* P11 - 0:PA11 1:       2:       3:          4:       7:     */
              | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:PA10 1:       2:       3:          4:       7:AN13 */
              | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PA9  1:TXD2   2:       3:          4:       7:AN12 */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PA8  1:RXD2   2:       3:          4:       7:AN11 */
    ...
    PB->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7  - 0:PB7  1:RXD1  2:        3:          4:       7: */
              ...
              | (0x03UL << PCU_MR1_P3MUX_Pos)    /* P3  - 0:PB3  1:      2:SS0     3:nBOOT     4:SS10   7: */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2  - 0:PB2  1:      2:SCK0    3:CLKO      4:SCK10  7:AN10 */
              | (0x00UL << PCU_MR1_P1MUX_Pos)    /* P1  - 0:PB1  1:RXD10 2:MISO0   3:EXT_SYNC  4:MISO10 7:AN9 */
              | (0x00UL << PCU_MR1_P0MUX_Pos);   /* P0  - 0:PB0  1:TXD10 2:MOSI0   3:          4:MOSI10 7:AN8 */

    PB->MR2 = 0x00UL
              | (0x03UL << PCU_MR2_P11MUX_Pos)   /* P11 - 0:PB11 1:      2:T8IO    3:          4:       7: */
              | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:PB10 1:      2:T9IO    3:          4:       7: */
              | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PB9  1:      2:T8IO    3:          4:       7: */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PB8  1:      2:T9IO    3:          4:       7: */
    ...
    PC->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7  - 0:PC7  1:      2:        3:          4:       7: */
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6  - 0:PC6  1:SCL2  2:        3:          4:       7: */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5  - 0:PC5  1:SDA2  2:        3:          4:       7: */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4  - 0:PC4  1:      2:        3:          4:       7: */
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3  - 0:PC3  1:      2:T7IO    3:          4:       7: */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2  - 0:PC2  1:      2:T5IO    3:          4:       7: */
              | (0x00UL << PCU_MR1_P1MUX_Pos)    /* P1  - 0:PC1  1:      2:T7IO    3:          4:       7: */
              | (0x00UL << PCU_MR1_P0MUX_Pos);   /* P0  - 0:PC0  1:      2:T5IO    3:RTCC_TAMP 4:       7: */

    PC->MR2 = 0x00UL
              | (0x03UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PC9  1:      2:        3:nRESET    4:       7: */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PC8  1:      2:        3:          4:       7: */
    ...
    PD->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P1  - 0:PD7  1:      2:I1IO     3:          4:       7: */
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P1  - 0:PD6  1:      2:T0IO     3:          4:       7: */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P1  - 0:PD5  1:      2:         3:          4:SS11   7: */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P1  - 0:PD4  1:      2:         3:          4:SCK11  7: */
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P1  - 0:PD3  1:RXD11 2:         3:RTCC_TAMP 4:MISO11 7: */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P1  - 0:PD2  1:TXD11 2:RTCC_OUT 3:          4:MOSI11 7: */
    ...
    PE->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7  - 0:PE7  1:MOSI1 2:T1IO     3:STBYO     4:       7: */
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6  - 0:PE6  1:MISO1 2:T0IO     3:WDTO      4:       7: */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5  - 0:PE5  1:SCK1  2:T4IO     3:          4:       7: */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4  - 0:PE4  1:SS1   2:T3IO     3:          4:       7: */
              | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3  - 0:PE3  1:TXD2  2:T2IO     3:          4:       7:AN17 */
              | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2  - 0:PE2  1:RXD2  2:T4IO     3:          4:       7:AN16 */
              | (0x00UL << PCU_MR1_P1MUX_Pos)    /* P1  - 0:PE1  1:      2:T3IO     3:          4:CP1OUT 7:AN15 */
              | (0x00UL << PCU_MR1_P0MUX_Pos);   /* P0  - 0:PE0  1:      2:T2IO     3:          4:CP0OUT 7:AN14 */

    PE->MR2 = 0x00UL
              | (0x00UL << PCU_MR2_P11MUX_Pos)   /* P11 - 0:PE11 1:      2:         3:SS12      4:       7: */
              | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:PE10 1:      2:         3:SCK12     4:       7: */
              | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PE9  1:RXD12 2:         3:MISO12    4:       7: */
              | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PE8  1:TXD12 2:         3:MOSI12    4:       7: */
    ...
    PF->MR1 = 0x00UL
              | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P1 - 0:PF7   1:      2:T4IO     3:          4:       7: */
              | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P1 - 0:PF6   1:      2:T3IO     3:          4:       7: */
              | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P1 - 0:PF5   1:      2:T2IO     3:          4:       7: */
              | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P1 - 0:PF4   1:      2:RTCC_OUT 3:CLKO      4:       7: */
              | (0x07UL << PCU_MR1_P3MUX_Pos)    /* P1 - 0:PF3   1:      2:         3:          4:       7:SXOUT */
              | (0x07UL << PCU_MR1_P2MUX_Pos)    /* P1 - 0:PF2   1:      2:         3:          4:       7:SXIN */
