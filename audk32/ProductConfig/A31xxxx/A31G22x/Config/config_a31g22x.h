/**
 *******************************************************************************
 * @file        config_a31g22x.h
 * @author      ABOV R&D Division
 * @brief       A31G22x config file
 *
...
#ifndef _CONFIG_A31G22X_H_
#define _CONFIG_A31G22X_H_
...
#define CONFIG_IRQ_25                    1    /* 0 : I2C2, 1 : SPI20 */
#define CONFIG_IRQ_26                    2    /* 0 : USART12, 1 : USART13, 2 : SPI21 */
#define CONFIG_IRQ_31                    0    /* 0 : CMP, 1 : CRC */
...
#define CONFIG_TIMER1_VER_EXT            1
...
#define TIMER16_IRQHandler               Interrupt24_Handler
...
#define CONFIG_TIMER2_VER_MINOR          1
...
#define CONFIG_TIMER3_VER_MINOR          1
...
#define CONFIG_UART_VER_MINOR            2
...
#elif (CONFIG_IRQ_26 == 1)
#define USART3_IRQHandler                Interrupt26_Handler
#else
#endif
...
#define USART_2_IRQ                      USART12_13_SPI21_IRQn
#define USART_3_IRQ                      USART12_13_SPI21_IRQn

/* USART DMA Config */
#define CONFIG_USART_DMA_START_NUM       17
...
#define CRC_0_IRQ                        CMP_CRC_IRQn
#else
/* CRC Interrupt Number */
#define CRC_0_IRQ                        (IRQn_Type)0xEF
#endif

/* CRC DMA Config */
#define CONFIG_CRC_DMA_START_NUM         5
...
#define I2C_2_IRQ                        I2C2_SPI20_IRQn
...
#if (CONFIG_IRQ_25 == 1)
#define SPI0_IRQHandler                  Interrupt25_Handler
#endif
#if (CONFIG_IRQ_26 == 2)
#define SPI1_IRQHandler                  Interrupt26_Handler
#endif

/* SPI Interrupt Number */
#define SPI_0_IRQ                        I2C2_SPI20_IRQn
#define SPI_1_IRQ                        USART12_13_SPI21_IRQn
...
#define DAC0_IRQHandler                  Interrupt27_Handler

/* DAC Interrupt Number */
#define DAC_0_IRQ                        DAC_IRQn

/* DAC Config */
#define CONFIG_DAC_OPS_INTERRUPT         0
#define CONFIG_DAC_OPS_INTERRUPT_DMA     1

/* DAC DMA Config */
#define CONFIG_DAC_DMA_START_NUM         14
#define DMA_DAC_NUM(x)                   (CONFIG_DAC_DMA_START_NUM)
...
#define CONFIG_FMC_VER_MAJOR             2
#define CONFIG_FMC_VER_EXT               1
#define CONFIG_FMC_VER_MINOR             0
#define CONFIG_FMC_REG_NAME              0

/* FMC Config */
#define CONFIG_FMC_TYPE_V2X              3

/* FMC Interrupt : None */

/* Bank switching */
#define CONFIG_CFMC_BANK_SWITCH          1
...
#define CONFIG_LCD_MAX_VLC_CH_NUM        4

#define CONFIG_LCD_UNUSE_SEG_CH_NUM      2
#define CONFIG_LCD_UNUSE_SEG_CH_0        5
#define CONFIG_LCD_UNUSE_SEG_CH_1        6
...
#define CMP0_IRQHandler                  Interrupt31_Handler
/* CMP Interrupt Number */
#define CMP_0_IRQ                        CMP_CRC_IRQn
#else
/* CMP Interrupt Number */
#define CMP_0_IRQ                        0xEF
#endif
...
#define TEMPSENS_0_IRQ                   TEMP_SENSOR_IRQn
