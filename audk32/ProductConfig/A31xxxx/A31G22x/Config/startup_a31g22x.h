...
#ifndef _STARTUP_A31G22X_H_
#define _STARTUP_A31G22X_H_
...
{
    if(SCUCC->CHIPID == 0x4D31A00A)
    {
        return (int8_t *)"A31G226 : Code Flash 256KB / Data Flash 32KB / SRAM 20KB";
    }
    else if(SCUCC->CHIPID == 0x4D31A00B)
    {
        return (int8_t *)"A31G224 : Code Flash 128KB / Data Flash 32KB / SRAM 20KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
RAMFUNC static __inline CONFIG_FLASH_INFO_t PRV_CHIPSET_GetFlashGeometricInfo(void)
{
    ...
    tFlashGeometricInfo.tDflash.tWProtectedBlocks[0].un32WProtectedSegSize = 0x400;
    tFlashGeometricInfo.tDflash.tWProtectedBlocks[0].un8NumWProtectedSegs = 32;
