/**
 *******************************************************************************
 * @file        config_a31g31x.h
 * @author      ABOV R&D Division
 * @brief       A31G31x config file
 *
...
#ifndef _CONFIG_A31G31X_H_
#define _CONFIG_A31G31X_H_
...
#define CONFIG_IRQ_26                    0    /* 0 : USART12, 1 : USART13 */
...
#define TIMER1_6_IRQ                     TIMER16_IRQn
...
#define CONFIG_TIMER2_VER_MINOR          0
...
#define CONFIG_TIMER3_VER_MINOR          0
...
#define CONFIG_UART_VER_MINOR            1
...
#define USART_2_IRQ                      USART12_13_IRQn
#define USART_3_IRQ                      USART12_13_IRQn
...
#define CRC_0_IRQ                        COMP_CRC_IRQn
#else
/* CRC Interrupt Number */
...
/* DAC Config */
#define CONFIG_DAC_OPS_INTERRUPT         1
...
#define CMP_0_IRQ                        COMP_CRC_IRQn
#else
/* CMP Interrupt Number */
...
#if defined(_MODULE_LED)

#define _LED                             1

/* LED IP version */
#define CONFIG_LED_VER_VENDOR           'V'
#define CONFIG_LED_VER_MAJOR             1
#define CONFIG_LED_VER_EXT               0
#define CONFIG_LED_VER_MINOR             0
#define CONFIG_LED_REG_NAME              0

/* LED Maximum IP Count */
#define CONFIG_LED_MAX_COUNT             1
#define CONFIG_LED_MAX_ICOM_CH_NUM       27
#define CONFIG_LED_MAX_ISEG_CH_NUM       11

/* LED Interrupt Handler */
#define LED0_IRQHandler                  Interrupt28_Handler

/* LED Interrupt Number */
#define LED_0_IRQ                        LED_IRQn
...
#endif /* _CONFIG_A31G31X_H_ */

/** @} */ /* End of group A31G31x */
