/**
 *******************************************************************************
 * @file        startup_a31s13x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A31S13x
 *
...
#ifndef _STARTUP_A31S13X_H_
#define _STARTUP_A31S13X_H_
...
{
    if(SCUCC->CHIPID == 0x53311340)
    {
        return (int8_t *)"A31S134 : Flash 128KB / SRAM 16KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
#define STARTUP_PAGE_SIZE                   0x100
...
static __inline void PRV_PORT_Init(void)
{
    ...
    PA->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR7_Pos)    /* PA7 - 0: AN7  1:        2:       3: MISO11  4: RXD11  5:      */
            | (0x00UL << Pn_AFSR1_AFSR6_Pos)    /* PA6 - 0: AN6  1:        2:       3: MOSI11  4: TXD11  5:      */
            | (0x00UL << Pn_AFSR1_AFSR5_Pos)    /* PA5 - 0: AN5  1:        2:       3:         4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR4_Pos)    /* PA4 - 0: AN4  1:        2:       3:         4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR3_Pos)    /* PA3 - 0: AN3  1:        2:       3:         4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* PA2 - 0: AN2  1:        2:       3:         4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* PA1 - 0: AN1  1:        2:       3:         4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* PA0 - 0: AN0  1: AVREF  2:       3:         4:        5:      */

    PA->AFSR2 = 0x00UL
            | (0x00UL << Pn_AFSR2_AFSR9_Pos)    /* PA9 - 0: AN9  1:       2:       3:          4: TXD1   5: SS10 */
            | (0x00UL << Pn_AFSR2_AFSR8_Pos);   /* PA8 - 0: AN8  1:       2:       3: SCK11    4: RXD1   5:      */
    ...
    PB->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR7_Pos)    /* PB7 - 0: T12OUT  1: T12CAP  2: EC12  3: MOSI0   4: TXD0   5:      */
            | (0x00UL << Pn_AFSR1_AFSR6_Pos)    /* PB6 - 0: T11OUT  1: T11CAP  2: EC11  3: MISO0   4: RXD0   5: SS12 */
            | (0x00UL << Pn_AFSR1_AFSR5_Pos)    /* PB5 - 0: T12OUT  1: T12CAP  2: EC12  3: SCK12   4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR4_Pos)    /* PB4 - 0: T13OUT  1: T13CAP  2: EC13  3: MISO12  4: RXD12  5: SCL0 */
            | (0x00UL << Pn_AFSR1_AFSR3_Pos)    /* PB3 - 0: T14OUT  1: T14CAP  2: EC14  3: MOSI12  4: TXD12  5: SDA0 */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* PB2 - 0: T15OUT  1: T15CAP  2: EC15  3: MOSI10  4: TXD10  5:      */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* PB1 - 0: T20OUT  1: T20CAP  2: EC20  3: MISO10  4: RXD10  5: SDA1 */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* PB0 - 0: T21OUT  1: T21CAP  2: EC21  3: SCK10   4:        5: SCL1 */

    PB->AFSR2 = 0x00UL
            | (0x00UL << Pn_AFSR2_AFSR11_Pos)   /* PB11 - 0:         1:         2:       3:        4: TXD1   5:      */
            | (0x00UL << Pn_AFSR2_AFSR10_Pos)   /* PB10 - 0:         1:         2:       3:        4: RXD1   5:      */
            | (0x00UL << Pn_AFSR2_AFSR9_Pos)    /* PB9  - 0:         1:         2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR2_AFSR8_Pos);   /* PB8  - 0: T11OUT  1: T11CAP  2: EC11  3: SCK0   4:        5:      */
    ...
    PC->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR7_Pos)    /* PC7 - 0: AN12    1:         2:       3: MOSI11  4: TXD11   5:      */
            | (0x00UL << Pn_AFSR1_AFSR6_Pos)    /* PC6 - 0: T10OUT  1: T10CAP  2:       3:         4:         5:      */
            | (0x00UL << Pn_AFSR1_AFSR5_Pos)    /* PC5 - 0:         1:         2: EC10  3:         4:         5:      */
            | (0x00UL << Pn_AFSR1_AFSR4_Pos)    /* PC4 - 0:         1:         2:       3:         4:         5:      */
            | (0x00UL << Pn_AFSR1_AFSR3_Pos)    /* PC3 - 0: AN11    1:         2:       3: T10OUT  4: T10CAP  5:      */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* PC2 - 0: AN10    1: CLKO    2:       3: T10OUT  4: T10CAP  5:      */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* PC1 - 0: T14OUT  1: T14CAP  2: EC14  3:         4:         5:      */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* PC0 - 0: T21OUT  1: T21CAP  2: EC21  3:         4:         5:      */

    PC->AFSR2 = 0x00UL
            | (0x00UL << Pn_AFSR2_AFSR10_Pos)   /* PC10- 0:         1:         2:       3: SS11    4:         5:      */
            | (0x00UL << Pn_AFSR2_AFSR9_Pos)    /* PC9 - 0:         1:         2:       3: SCK11   4:         5: SCL0 */
            | (0x00UL << Pn_AFSR2_AFSR8_Pos);   /* PC8 - 0: AN13    1:         2:       3: MISO11  4: RXD11   5: SDA0 */
    ...
    PD->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR7_Pos)    /* PD7 - 0:         1:         2:       3: SCK1    4:        5: SCL2 */
            | (0x00UL << Pn_AFSR1_AFSR6_Pos)    /* PD6 - 0: T13OUT  1: T13CAP  2: EC13  3: MISO12  4: RXD12  5: SDA2 */
            | (0x00UL << Pn_AFSR1_AFSR5_Pos)    /* PD5 - 0:         1:         2:       3: MOSI12  4: TXD12  5: SCL2 */
            | (0x00UL << Pn_AFSR1_AFSR4_Pos)    /* PD4 - 0: T13OUT  1: T13CAP  2: EC13  3: SCK12   4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR3_Pos)    /* PD3 - 0: T20OUT  1: T20CAP  2: EC20  3:         4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* PD2 - 0: T21OUT  1: T21CAP  2: EC21  3:         4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* PD1 - 0:         1:         2:       3:         4:        5: SDA0 */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* PD0 - 0:         1:         2:       3:         4:        5: SCL0 */

    PD->AFSR2 = 0x00UL
            | (0x00UL << Pn_AFSR2_AFSR8_Pos);   /* PD8 - 0:         1:         2:       3: MISO1   4:        5: SDA2 */
    ...
    PE->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR7_Pos)    /* PE7 - 0:         1:         2:       3: MISO1  4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR6_Pos)    /* PE6 - 0:         1:         2:       3: SCK1	  4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR5_Pos)    /* PE5 - 0: T15OUT  1: T15CAP  2: EC15  3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR4_Pos)    /* PE4 - 0: T20OUT  1: T20CAP  2: EC20  3:        4:        5: SS0  */
            | (0x00UL << Pn_AFSR1_AFSR3_Pos)    /* PE3 - 0:         1:         2:       3: SCK0	  4: SCL1   5:      */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* PE2 - 0:         1:         2:       3: MISO0  4: SDA1   5:      */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* PE1 - 0:         1:         2:       3: MOSI0  4:        5: SS1  */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* PE0 - 0:         1:         2:       3: MOSI1  4:        5:      */

    PE->AFSR2 = 0x00UL
            | (0x00UL << Pn_AFSR2_AFSR8_Pos);   /* PE8 - 0:         1:         2:       3: MOSI1  4:        5:      */
    ...
    PF->MOD = 0x00UL  /* 0 : Input Mode 1 : Output Mode 2 : Alternative function mode */
            ...
            | (0x00UL << Pn_MOD_MODE3_Pos)      /* P3 */
            | (0x00UL << Pn_MOD_MODE2_Pos)      /* P2 */
            | (0x02UL << Pn_MOD_MODE1_Pos)      /* P1 - SWCLK*/
            | (0x02UL << Pn_MOD_MODE0_Pos);     /* P0 - SWDIO*/
    ...
    PF->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR7_Pos)    /* PF7 - 0:        1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR6_Pos)    /* PF6   0: XOUT   1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR5_Pos)    /* PF5   0: XIN    1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR4_Pos)    /* PF4   0: SXOUT  1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR3_Pos)    /* PF3   0: SXIN   1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* PF2 - 0:        1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* PF1   0: SWCLK  1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* PF0   0: SWDIO  1:       2:       3:        4:        5:      */

    PF->AFSR2 = 0x00UL
            | (0x00UL << Pn_AFSR2_AFSR9_Pos)    /* PF9 - 0:        1:       2:       3:        4:        5:      */
            | (0x00UL << Pn_AFSR2_AFSR8_Pos);   /* PF8 - 0:        1:       2:       3:        4:        5:      */
    ...
    PF->PUPD = 0x00UL  /* 0 : Disable Pull-up/down 1 : Enable Pull-up 2 : Enable Pull-down */
            ...
            | (0x00UL << Pn_PUPD_PUPD3_Pos)     /* P3 */
            | (0x00UL << Pn_PUPD_PUPD2_Pos)     /* P2 */
            | (0x02UL << Pn_PUPD_PUPD1_Pos)     /* P1 - SWCLK */
            | (0x01UL << Pn_PUPD_PUPD0_Pos);    /* P0 - SWDIO */
