 ...
 * XXX_BASE defines Chipset header file (a33XXX.h) created by SVD file.
 */
...
/* TIMER1n Module */
#if (CONFIG_HAL_TIMER1 == 1) && (defined(TIMER10_BASE) || defined(T0_BASE) || defined(TIMER0_BASE))
...
#if (CONFIG_HAL_AFE == 1) && defined(AFE_BASE)
#define _MODULE_AFE
#endif
