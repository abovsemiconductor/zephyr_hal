/**
 *******************************************************************************
 * @file        config_a34m41x.h
 * @author      ABOV R&D Division
 * @brief       A34M41x config file
 *
...
#ifndef CONFIG_A34M41X_H
#define CONFIG_A34M41X_H
...
#define CMP_0_IRQ                         COMP0_IRQn
#define CMP_1_IRQ                         COMP1_IRQn
#define CMP_2_IRQ                         COMP2_IRQn
#define CMP_3_IRQ                         COMP3_IRQn
...
#if defined(_MODULE_PGA)

#define _PGA                              1

/* PGA IP version */
#define CONFIG_PGA_VER_VENDOR            'V'
#define CONFIG_PGA_VER_MAJOR              1
#define CONFIG_PGA_VER_EXT                0
#define CONFIG_PGA_VER_MINOR              0
#define CONFIG_PGA_REG_NAME               0

/* PGA Maximum IP Count */
#define CONFIG_PGA_MAX_COUNT              3
