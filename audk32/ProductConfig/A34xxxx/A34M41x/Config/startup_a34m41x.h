/**
 *******************************************************************************
 * @file        startup_a34m41x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A34M41x
 *
...
#ifndef _STARTUP_A34M41X_H_
#define _STARTUP_A34M41X_H_
...
{
    if(CHIPCONFIG->CHIPID == 0x4D34A000)
    {
        return (int8_t *)"A34M418 : Flash 512KB / SRAM 64KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A001)
    {
        return (int8_t *)"A34M416 : Flash 256KB / SRAM 64KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A002)
    {
        return (int8_t *)"A34M41x : Flash 128KB / SRAM 64KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A010)
    {
        return (int8_t *)"A34M41x : Flash 512KB / SRAM 32KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A011)
    {
        return (int8_t *)"A34M41x : Flash 256KB / SRAM 32KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A012)
    {
        return (int8_t *)"A34M41x : Flash 128KB / SRAM 32KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A020)
    {
        return (int8_t *)"A34M41x : Flash 512KB / SRAM 16KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A021)
    {
        return (int8_t *)"A34M41x : Flash 256KB / SRAM 16KB";
    }
    else if(CHIPCONFIG->CHIPID == 0x4D34A022)
    {
        return (int8_t *)"A34M414 : Flash 128KB / SRAM 16KB";
    }
    else
    {
        return (int8_t *)"Unknown";
