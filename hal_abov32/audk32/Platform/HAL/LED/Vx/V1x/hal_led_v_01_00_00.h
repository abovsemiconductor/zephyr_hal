/**
 *******************************************************************************
 * @file        hal_led_v_01_00_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.00 typed LED
 *
...
#ifndef _HAL_LED_V_01_00_00_H_
#define _HAL_LED_V_01_00_00_H_
...
#define SET_LED_STPD_DURATION(Peri,Data)              SET_BIT(Peri,Data,LED,STPD,LEDSTPD)
#define SET_LED_CON2_COMSEG(Peri,Data)                SET_BIT(Peri,Data,LED,CON2,COM_SEGN)
#define SET_LED_CON2_OVERLAP(Peri,Data)               SET_BIT(Peri,Data,LED,CON2,OVERLAP)
#define SET_LED_CON2_OVERLAPTIME(Peri,Data)           SET_BIT(Peri,Data,LED,CON2,OVERTS)
#define SET_LED_CON1_MODESEL(Peri,Data)               SET_BIT(Peri,Data,LED,CON1,MD)
#define SET_LED_CON1_LEDEN(Peri,Data)                 SET_BIT(Peri,Data,LED,CON1,LEDEN)
#define SET_LED_CON1_START(Peri,Data)                 SET_BIT(Peri,Data,LED,CON1,LEDST)
#define GET_LED_DIMMING_BASE_ADDR(Peri)               GET_REG_ADDR(Peri,DIMM0)
#define SET_LED_DR_DIMMING(Addr,Id,Data)              SET_BIT_ADDR_DATA_OFFSET(Addr,LED_DIMM_ADDR_OFFSET(Id),LED_DIMM_DATA_OFFSET(Id),Data,LED,DIMM0,COMDIMM0)
...
#define SET_LED_INTR_LEDINTR(Peri,Data)               SET_BIT(Peri,Data,LED,SR,LED_INT)
#define GET_LED_INTR_LEDINTR(Peri)                    GET_BIT(Peri,LED,SR,LED_INT)
