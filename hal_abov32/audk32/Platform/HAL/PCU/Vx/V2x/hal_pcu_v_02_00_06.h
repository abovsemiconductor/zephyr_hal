...
#ifndef _HAL_PCU_V_02_00_06_H_
#define _HAL_PCU_V_02_00_06_H_

#define PCU_FEATURE_SUPPORT_LOW_VOLTAGE
#define PCU_FEATURE_SUPPORT_OPENDRAIN

/* Internal Macro */
typedef PCU_Type                                      PORT_Type;
typedef PCU_Type                                      GPIO_Type;
typedef PORTEN_Type                                   PCU_PORTEN_Type;
typedef PORTLVINER_Type                               LVINER_Type;
...
#define PCU_AFODCR_BASE                               PORTAFODCR_BASE
...
#define PCU_LVINER_ID_PIN(id, pin)                    ((((uint16_t)(id)) << 8U) | ((uint16_t)(pin)))
#define PCU_AFODCR_ID_PIN(id, pin)                    ((((uint16_t)(id)) << 8U) | ((uint16_t)(pin)))
...
#define SET_PCU_LVINER_EN(Peri,Data,Pos)              SET_REG_BIT(Peri,Data,LVINER,MASK_1BIT,Pos)
#define SET_PCU_AFODCR_EN(Peri,Data,Pos)              SET_REG_BIT(Peri,Data,AFODCR,MASK_1BIT,Pos)
