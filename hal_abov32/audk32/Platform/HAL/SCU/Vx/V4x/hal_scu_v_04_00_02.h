...
#define SCU_FEATURE_SUPPORT_LVI_ALWAYS_ON
#define SCU_FEATURE_SUPPORT_LVR_ALWAYS_ON
...
#define SET_SCU_CLK_RST_SRC_MCLK_EN(Peri,Data)        (void)Peri
#define GET_SCU_CLK_RST_SRC_MCLK_EN(Peri)             0
#define SET_SCU_CLK_RST_SRC_MCLK_FLAG(Peri,Data)      (void)Peri
#define GET_SCU_CLK_RST_SRC_MCLK_FLAG(Peri)           0
...
#define SET_SCU_BOOTSR_BC(Peri,Data)                 SET_BIT(Peri,Data,SCU,BOOTSR,BC)
#define GET_SCU_BOOTSR_BC(Peri)                      GET_BIT(Peri,SCU,BOOTSR,BC)

/* Unused Macro */
#define SET_SCU_CMR_MCLKREC(Peri,Data)                (void)Peri
#define SET_SCU_CMR_MCLKMNT(Peri,Data)                (void)Peri
