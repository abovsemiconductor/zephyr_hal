/**
 *******************************************************************************
 * @file        hal_tempsens_v1x.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for V1x typed TempSens
 *
...
#ifndef _HAL_TEMPSENS_V1X_H_
#define _HAL_TEMPSENS_V1X_H_
...
#include "hal_tempsens_v_01_00_00.h"
#elif (CONFIG_TEMPSENS_VER_MINOR == 1)
#include "hal_tempsens_v_01_00_01.h"
#else
#error "define CONFIG_TEMPSENS_VER_MINOR of V-type TEMPSENS at config_xxx.h"
#endif

#else
#error "define CONFIG_TEMPSENS_VER_EXT of V-type TEMPSENS at config_xxx.h"
#endif
...
static __inline HAL_ERR_e TEMPSENS_SetScuEnable(P_TEMPSENS_ID_e eId, uint32_t un32Enable)
{
    ...
    SET_SCU_TEMPSENS_PER(ptScu, (uint32_t)eId, un32Enable);
    SET_SCU_TEMPSENS_PCER(ptScu, (uint32_t)eId, un32Enable);
...
static __inline HAL_ERR_e TEMPSENS_SetClk(P_TEMPSENS_ID_e eId, P_TEMPSENS_REF_CLK_e eRefClk, P_TEMPSENS_SEN_CLK_e eSenClk)
{
    ...
    SET_SCU_TEMPSENS_MCCR_SEN(ptScu, (uint32_t)eId, (uint8_t)eSenClk);
    SET_SCU_TEMPSENS_MCCR_REF(ptScu, (uint32_t)eId, (uint8_t)eRefClk);
...
static __inline HAL_ERR_e TEMPSENS_SetRefCount(P_TEMPSENS_ID_e eId, P_TEMPSENS_REF_CLK_e eRefClk)
{
    ...
    switch(eRefClk)
    {
        case P_TEMPSENS_REF_CLK_HSI:
            un32RefCount = (HSI_CLOCK / TEMPSENS_REF_CLK_DIV); 
            break;
        case P_TEMPSENS_REF_CLK_MCLK:
            un32RefCount = (SystemCoreClock / TEMPSENS_REF_CLK_DIV); 
            break;
        case P_TEMPSENS_REF_CLK_HSE:
            un32RefCount = (HSE_CLOCK / TEMPSENS_REF_CLK_DIV); 
            break;
        case P_TEMPSENS_REF_CLK_LSE:
            un32RefCount = (LSE_CLOCK / TEMPSENS_REF_CLK_DIV); 
            break;
        default:
