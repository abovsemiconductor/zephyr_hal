/**
 *******************************************************************************
 * @file        hal_timer3_f_01_00_01.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.01 typed timer3
 *
...
#ifndef _HAL_TIMER3_F_01_00_01_H_
#define _HAL_TIMER3_F_01_00_01_H_

/* Feature(Function) Configuration Define */
#define TIMER3_FEATURE_NMI_BLANK                     
...
/* Position & Mask Macro */
#define SET_TIMER3_CR_MODE_POS(Data)                  SET_POS(Data,TIMER30,CR,MS)
...
#define SET_TIMER3_CR_CAPPORT_POS(Data)               SET_POS(Data,TIMER30,CR,CPOL)
...
#define TIMER3_CR_MODE_MSK                            BIT_NAME_MSK(TIMER30_,CR_,MS_)
...
#define SET_TIMER3_CR_MODE(Peri,Data)                 SET_BIT(Peri,Data,TIMER30,CR,MS)
#define GET_TIMER3_CR_MODE(Peri)                      GET_BIT(Peri,TIMER30,CR,MS)
#define SET_TIMER3_CR_EN(Peri,Data)                   SET_BIT(Peri,Data,TIMER30,CR,EN)
#define GET_TIMER3_CR_EN(Peri)                        GET_BIT(Peri,TIMER30,CR,EN)
...
#define SET_TIMER3_CR_CAPPORT_POL(Peri,Data)          SET_BIT(Peri,Data,TIMER30,CR,CPOL)
#define GET_TIMER3_CR_CAPPORT_POL(Peri)               GET_BIT(Peri,TIMER30,CR,CPOL)
#define SET_TIMER3_CR_CLK(Peri,Data)                  SET_BIT(Peri,Data,TIMER30,CR,CLK)
#define GET_TIMER3_CR_CLK(Peri)                       GET_BIT(Peri,TIMER30,CR,CLK)
#define SET_TIMER3_CR_CLR(Peri,Data)                  SET_BIT(Peri,Data,TIMER30,CR,CLR)
#define GET_TIMER3_CR_CLR(Peri)                       GET_BIT(Peri,TIMER30,CR,CLR)
#define SET_TIMER3_CR_EXTCLK_EDGE(Peri,Data)          SET_BIT(Peri,Data,TIMER30,CR,ECE)
...
/* Interrup Bit Macro */
#define SET_TIMER3_IER_MATCH_A_EN(Peri,Data)          SET_BIT(Peri,Data,TIMER30,INTCR,AMIEN)
#define GET_TIMER3_IER_MATCH_A_EN(Peri)               GET_BIT(Peri,TIMER30,INTCR,AMIEN)
#define SET_TIMER3_IER_MATCH_B_EN(Peri,Data)          SET_BIT(Peri,Data,TIMER30,INTCR,BMIEN)
#define GET_TIMER3_IER_MATCH_B_EN(Peri)               GET_BIT(Peri,TIMER30,INTCR,BMIEN)
#define SET_TIMER3_IER_MATCH_C_EN(Peri,Data)          SET_BIT(Peri,Data,TIMER30,INTCR,CMIEN)
#define GET_TIMER3_IER_MATCH_C_EN(Peri)               GET_BIT(Peri,TIMER30,INTCR,CMIEN)
#define SET_TIMER3_IER_MATCH_P_EN(Peri,Data)          SET_BIT(Peri,Data,TIMER30,INTCR,PMIEN)
#define GET_TIMER3_IER_MATCH_P_EN(Peri)               GET_BIT(Peri,TIMER30,INTCR,PMIEN)
#define SET_TIMER3_IER_BOTTOM_EN(Peri,Data)           SET_BIT(Peri,Data,TIMER30,INTCR,BTIEN)
#define GET_TIMER3_IER_BOTTOM_EN(Peri)                GET_BIT(Peri,TIMER30,INTCR,BTIEN)
#define SET_TIMER3_IER_CAP_EN(Peri,Data)              SET_BIT(Peri,Data,TIMER30,INTCR,CIEN)
#define GET_TIMER3_IER_CAP_EN(Peri)                   GET_BIT(Peri,TIMER30,INTCR,CIEN)
...
#define SET_TIMER3_IER_MATCH_A_FLAG(Peri,Data)        SET_BIT(Peri,Data,TIMER30,INTFLAG,AMIFLAG)
#define GET_TIMER3_IER_MATCH_A_FLAG(Peri)             GET_BIT(Peri,TIMER30,INTFLAG,AMIFLAG)
#define SET_TIMER3_IER_MATCH_B_FLAG(Peri,Data)        SET_BIT(Peri,Data,TIMER30,INTFLAG,BMIFLAG)
#define GET_TIMER3_IER_MATCH_B_FLAG(Peri)             GET_BIT(Peri,TIMER30,INTFLAG,BMIFLAG)
#define SET_TIMER3_IER_MATCH_C_FLAG(Peri,Data)        SET_BIT(Peri,Data,TIMER30,INTFLAG,CMIFLAG)
#define GET_TIMER3_IER_MATCH_C_FLAG(Peri)             GET_BIT(Peri,TIMER30,INTFLAG,CMIFLAG)
#define SET_TIMER3_IER_MATCH_P_FLAG(Peri,Data)        SET_BIT(Peri,Data,TIMER30,INTFLAG,PMIFLAG)
#define GET_TIMER3_IER_MATCH_P_FLAG(Peri)             GET_BIT(Peri,TIMER30,INTFLAG,PMIFLAG)
#define SET_TIMER3_IER_BOTTOM_FLAG(Peri,Data)         SET_BIT(Peri,Data,TIMER30,INTFLAG,BTIFLAG)
#define GET_TIMER3_IER_BOTTOM_FLAG(Peri)              GET_BIT(Peri,TIMER30,INTFLAG,BTIFLAG)
#define SET_TIMER3_IER_CAP_FLAG(Peri,Data)            SET_BIT(Peri,Data,TIMER30,INTFLAG,CIFLAG)
#define GET_TIMER3_IER_CAP_FLAG(Peri)                 GET_BIT(Peri,TIMER30,INTFLAG,CIFLAG)
...
#endif /* _HAL_TIMER3_F_01_00_01_H_ */
