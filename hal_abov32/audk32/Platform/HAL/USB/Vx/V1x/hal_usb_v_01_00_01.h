/**
 *******************************************************************************
 * @file        hal_usb_v_01_00_01.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.01 typed USB
 *
...
#ifndef _HAL_USB_V_01_00_01_H_
#define _HAL_USB_V_01_00_01_H_

/* Feature(Function) Configuration Define */
#define USB_FEATURE_USE_MCCR_CLOCK
#define USB_FEATURE_NMI
#define USB_FEATURE_IRQ_UNMASK_ENABLE
#define USB_FEATURE_POWER_ENABLE
...
#define GET_USB_POWER(Peri)                           GET_REG(Peri,POWER)
...
#define SET_USB_SUSPEND_EN(Peri,Data)                 SET_BIT(Peri,Data,USB,PHYCR,PHYDIS)

#define SET_USB_EP0_SR0(Peri,Data)                    SET_REG(Peri,Data,CSR0)
#define GET_USB_EP0_SR0(Peri)                         GET_REG(Peri,CSR0)
...
#define SET_USB_EP0_FIFO(Peri,Data)                   SET_REG(Peri,Data,FIFO0)
#define GET_USB_EP0_FIFO(Peri)                        GET_REG(Peri,FIFO0)

#define SET_USB_EP0_PULLUP(Peri,Data)                 SET_REG(Peri,Data,PUPDCR)
#define SET_USB_EP0_SR0_SENTSTALL(Peri,Data)          SET_BIT(Peri,Data,USB,CSR0,SENTSTALL_UNDERRUN)
#define SET_USB_EP0_SR0_SENDSTALL(Peri,Data)          SET_BIT(Peri,Data,USB,CSR0,SENDSTALL_SENTSTALL)
#define SET_USB_EP0_SR0_SETUPEND(Peri,Data)           SET_BIT(Peri,Data,USB,CSR0,SETUPEND_SENDSTALL)
#define SET_USB_EP0_SR0_SRVSETUPEND(Peri,Data)        SET_BIT(Peri,Data,USB,CSR0,SERVICEDSETUPEND)
#define SET_USB_EP0_SR0_SRVOUTPKTRDY(Peri,Data)       SET_BIT(Peri,Data,USB,CSR0,SERVICEDOUTPKTRDY_CLRDATATOG)
#define SET_USB_EP0_SR0_INPKTRDY(Peri,Data)           SET_BIT(Peri,Data,USB,CSR0,INPKTRDY_FIFONOTEMPTY)
#define SET_USB_EP0_SR0_DATAEND(Peri,Data)            SET_BIT(Peri,Data,USB,CSR0,DATAEND_FLUSHFIFO)
#define GET_USB_EP0_RX_CNT(Peri)                      GET_REG(Peri,COUNT0)
...
#define GET_USB_EPX_FIFO_BASE_ADDR(Peri)              GET_REG_ADDR(Peri,FIFO0)

/* Interrupt Macro */
#define SET_USB_IER(Peri,Data)                        SET_REG(Peri,Data,INTRUSBE)
#define GET_USB_IER(Peri)                             GET_REG(Peri,INTRUSBE)
...
#define SET_USB_IER_INEP_EN(Peri,Data)                SET_REG(Peri,Data,INTRIN1E)
#define GET_USB_IER_INEP_EN(Peri)                     GET_REG(Peri,INTRIN1E)

/* SCU Macro */
#define SCU_ADDR                                      SCUCG_BASE
#define SCU_USB_MCCR_MODE(x)                          (x == 4 ? 4 : 5)
#define SET_SCU_USB_PER(Peri,Id,Data)                 (void)Peri
#define SET_SCU_USB_PCER(Peri,Id,Data)                SET_BIT(Peri,Data,SCUCG,PPCLKEN2,USBCLKE)

#define SET_SCU_USB_MCCR_SEL0(Peri,Data)              SET_BIT(Peri,Data,SCUCG,PPCLKSR,USBCLK)
#define SET_SCU_USB_MCCR_DIV0(Peri,Data)              (void)Peri
