/**
 *******************************************************************************
 * @file        debug_a31c11x.h
 * @author      ABOV R&D Division
 * @brief       A31C11x debug config file
 *
...
#ifndef _DEBUG_A31C11X_H_
#define _DEBUG_A31C11X_H_
...
#define CONFIG_DEBUG_SERIAL_TX_FIFO_SIZE          64
#define CONFIG_DEBUG_SERIAL_TX_FIFO_FLUSH_SIZE    32

#if (CONFIG_DEBUG == 1)
#if ((TARGET_SERIAL_MODULE == BD_SERIAL_MODULE_NONE) || (TARGET_SERIAL_MODULE == BD_SERIAL_MODULE_USART))
#undef CONFIG_HAL_USART
...
#error Only USART channel id 0 as a debug log can be used.
#endif
...
#define DEBUG_RX_PORT_ID                 1
#define DEBUG_RX_ALT_ID                  4
#define DEBUG_TX_PORT_ID                 0
#define DEBUG_TX_ALT_ID                  4
