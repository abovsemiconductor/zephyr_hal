 ...
 * @brief       Board configuration on which A31C15x is mounted
 *
...
/* SPI0 Port */
#define SPI0_SS_PORT                1    /* Port A */
#define SPI0_SS_PORT_ID             3
#define SPI0_SS_MUX_ID              2
#define SPI0_SCK_PORT               1    /* Port A */
#define SPI0_SCK_PORT_ID            4
#define SPI0_SCK_MUX_ID             2
#define SPI0_MOSI_PORT              1    /* Port A */
#define SPI0_MOSI_PORT_ID           0
#define SPI0_MOSI_MUX_ID            2
#define SPI0_MISO_PORT              1    /* Port A */
#define SPI0_MISO_PORT_ID           1
