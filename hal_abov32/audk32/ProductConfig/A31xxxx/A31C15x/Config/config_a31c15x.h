/**
 *******************************************************************************
 * @file        config_a31c15x.h
 * @author      ABOV R&D Division
 * @brief       A31C15x config file
 *
...
#ifndef CONFIG_A31C15X_H
#define CONFIG_A31C15X_H
...
#define CONFIG_IRQ_3                     0    /* 0 : LSEFAIL, 1 : RTC */
#define CONFIG_IRQ_23                    0    /* 0 : CRC, 1 : UART2 */
#define CONFIG_IRQ_24                    0    /* 0 : CMP0, 1 : SPI0 */
#define CONFIG_IRQ_25                    0    /* 0 : CMP1, 1 : SPI1 */
...
#define CONFIG_UART_MAX_COUNT            3
...
/* UART DMA Config */
#define CONFIG_UART0_DMA_START_NUM        1
#define CONFIG_UART1_DMA_START_NUM        3
#define CONFIG_UART2_DMA_START_NUM        13
#define DMA_UART_NUM(x, y)                (((x) == 0) ? (CONFIG_UART0_DMA_START_NUM + (y)) : \
                                          (((x) == 1) ? (CONFIG_UART1_DMA_START_NUM + (y)) : \
                                          (((x) == 2) ? (CONFIG_UART2_DMA_START_NUM + (y)) : -1)))
...
#endif
#if (CONFIG_IRQ_25 == 1)
#define SPI1_IRQHandler                  Interrupt25_Handler
#endif

/* SPI Interrupt Number */
#define SPI_0_IRQ                        CMP0_SPI0_IRQn
#define SPI_1_IRQ                        CMP1_SPI1_IRQn
...
#define CONFIG_FMC_VER_MINOR            4
#define CONFIG_FMC_REG_NAME             0

/* FMC IRQ */
#define CFMC_IRQ_Handler                Interrupt6_Handler
#if (CONFIG_IRQ_2 == 1)
#define DFMC_IRQ_Handler                Interrupt2_Handler
#endif
...
#define CMP_1_IRQ                        CMP1_SPI1_IRQn
