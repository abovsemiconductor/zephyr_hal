/**
 *******************************************************************************
 * @file        startup_a31g11x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A31G11x
 *
...
#ifndef _STARTUP_A31G11X_H_
#define _STARTUP_A31G11X_H_
...
#define HSI_CLOCK   (40000000)  /* The clock speed of Internal High Speed Oscillator (HIRC) */
...
{
    if(SCUCC->CHIPID == 0x4D31F000)
    {
        return (int8_t *)"A31G112 : Flash 32KB / SRAM 4KB";
    }
    else if(SCUCC->CHIPID == 0x4D31F001)
    {
        return (int8_t *)"A31G111 : Flash 16KB / SRAM 4KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
static __inline void PRV_PORT_Init(void)
{
    ...
    PB->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR7_Pos)    /* P7  - 0 : SEG18 1 : RXD1  2 :        3 :      4 : */
            | (0x00UL << Pn_AFSR1_AFSR6_Pos)    /* P6  - 0 : SEG19 1 : TXD1  2 :        3 :      4 : */
            | (0x02UL << Pn_AFSR1_AFSR5_Pos)    /* P5  - 0 : SEG20 1 : RXD0  2 : SWDIO  3 :      4 : */
            | (0x02UL << Pn_AFSR1_AFSR4_Pos)    /* P4  - 0 : SEG21 1 : TXD0  2 : SWCLK  3 :      4 : */
            | (0x01UL << Pn_AFSR1_AFSR3_Pos)    /* P3  - 0 : SEG22 1 : BOOT  2 : SS10   3 :      4 : */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* P2  - 0 : SEG23 1 :       2 : SCK10  3 : AN10 4 : */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* P1  - 0 : SEG24 1 : RXD10 2 : MISO10 3 : AN9  4 : */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* P0  - 0 : SEG25 1 : TXD10 2 : MOSI10 3 : AN8  4 : */
    ...
    PC->AFSR1 = 0x00UL
            | (0x00UL << Pn_AFSR1_AFSR4_Pos)    /* P4  - 0 : SEG13 1 :        2 :        3 : 4 : */
            | (0x00UL << Pn_AFSR1_AFSR3_Pos)    /* P3  - 0 : SEG14 1 : EC21   2 :        3 : 4 : */
            | (0x00UL << Pn_AFSR1_AFSR2_Pos)    /* P2  - 0 : SEG15 1 : EC20   2 :        3 : 4 : */
            | (0x00UL << Pn_AFSR1_AFSR1_Pos)    /* P1  - 0 : SEG16 1 : T21OUT 2 : T21CAP 3 : 4 : */
            | (0x00UL << Pn_AFSR1_AFSR0_Pos);   /* P0  - 0 : SEG17 1 : T20OUT 2 : T20CAP 3 : 4 : */
