/**
 *******************************************************************************
 * @file        startup_a31g12x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A31G12x
 *
...
#ifndef _STARTUP_A31G12X_H_
#define _STARTUP_A31G12X_H_
...
{
    if(SCUCC->CHIPID == 0x4D31F002)
    {
        return (int8_t *)"A31G123 : Flash 64KB / SRAM 6KB";
    }
    else if(SCUCC->CHIPID == 0x4D31F003)
    {
        return (int8_t *)"A31G122 : Flash 32KB / SRAM 6KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
static __inline void PRV_PORT_Init(void)
{
    ...
    PA->AFSR2 = 0x00UL
            | (0x00UL << Pn_AFSR2_AFSR11_Pos)   /* P3  - 0 : 1 : 2 : 3 :      4 :  */
            | (0x00UL << Pn_AFSR2_AFSR10_Pos)   /* P2  - 0 : 1 : 2 : 3 : AN13 4 :  */
            | (0x00UL << Pn_AFSR2_AFSR9_Pos)    /* P1  - 0 : 1 : 2 : 3 : AN12 4 :  */
            | (0x00UL << Pn_AFSR2_AFSR8_Pos);   /* P0  - 0 : 1 : 2 : 3 : AN11 4 :  */
