 ...
 *           from CMSIS SVD File 'a31g21x.svd' Version 1.0,
 *
...
#include "system_a31xxxx.h"                         /*!< A31G21x System                                                        */
...
typedef struct {                                    /*!< PCU Structure                                                         */
  __IO uint32_t  KEYR;                              /*!< Port LED KEY Register                                                 */
  __IO uint32_t  SEGR;                              /*!< Port LED SEG Register                                                 */
  __IO uint32_t  COMR;                              /*!< Port LED COM Register                                                 */
  __I  uint32_t  RESERVED[57];
  __IO uint32_t  PORTEN;                            /*!< Port Access Enable 0x15->0x51                                         */
} PCU_Type;
...
typedef struct {                                    /*!< FMC Structure                                                         */
  ...
  __I  uint32_t  RESERVED2;
  __IO uint32_t  CRC;                               /*!< Flash CRC-CCITT check value                                           */
  __I  uint32_t  RESERVED3[3];
...
typedef struct {                                    /*!< DAC Structure                                                         */
  ...
  __IO uint32_t  DR;                                /*!< D/A Converter Buffer Register                                         */
  __IO uint32_t  DACEN;                             /*!< D/A Converter Control TEST Register                                   */
} DAC_Type;
...
typedef struct {                                    /*!< TOUCH Structure                                                       */
  __I  uint32_t  SUM_CH0;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH1;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH2;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH3;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH4;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH5;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH6;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH7;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH8;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH9;                           /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH10;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH11;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH12;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH13;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH14;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH15;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH16;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH17;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH18;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH19;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH20;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH21;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH22;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  __I  uint32_t  SUM_CH23;                          /*!< Touch Sensor Channel 0~23 Sum Register                                */
  ...
  __I  uint32_t  RESERVED1;
  __IO uint32_t  SLP_CR;                            /*!< Touch Sensor Low Pass Filter Control Register                         */
  __IO uint32_t  ADC_CH_SEL;                        /*!< ADC Channel Selection Register                                        */
  __IO uint32_t  INTEG_CNT;                         /*!< Touch Sensor Sensing Integration Count Register                       */
  __IO uint32_t  FREQ_NUM;                          /*!< Touch Sensor Frequency Number Register                                */
  __IO uint32_t  FREQ_DEL;                          /*!< Touch Sensor Frequency Delta Register                                 */
  ...
  __IO uint32_t  TRIM_A_OSC;                        /*!< Touch Sensor RING Oscillator Trimming for ADC Register                */
  __IO uint32_t  SCI;                               /*!< Touch Sensor Input Capacitor Selection Register                       */
  __IO uint32_t  SCC;                               /*!< Touch Sensor Conversion Capacitor Selection Register                  */
  __IO uint32_t  SVREF;                             /*!< Touch Sensor VREF Resistor Selection Register                         */
  __IO uint32_t  TAR;                               /*!< Touch Sensor Integration AMP Reset Register                           */
  __IO uint32_t  TRST;                              /*!< Touch Sensor Reset time of Sensing Register                           */
  __IO uint32_t  TDRV;                              /*!< Touch Sensor Sample time of Sensing Register                          */
  __IO uint32_t  TINT;                              /*!< Touch Sensor Integration time of Sensing Register                     */
  __IO uint32_t  TD;                                /*!< Touch Sensor Differential AMP Sampling Register                       */
  __IO uint32_t  TWR;                               /*!< Touch Sensor Wait time Register                                       */
...
typedef struct {                                    /*!< LED Structure                                                         */
  ...
  __IO uint32_t  COMER;                             /*!< COM EnableRegister                                                    */
  __IO uint32_t  COMPWID;                           /*!< COM Pulse Width Control Register                                      */
  __IO uint32_t  DIMM1;                             /*!< COM Dimming Control Register1                                         */
  __IO uint32_t  DIMM2;                             /*!< COM Dimming Control Register2                                         */
  __IO uint32_t  DIMM3;                             /*!< COM Dimming Control Register3                                         */
  __IO uint32_t  DIMM4;                             /*!< COM Dimming Control Register4                                         */
  __I  uint32_t  RESERVED[3];
  __IO uint32_t  STPD;                              /*!< LED STOP Duration Register                                            */
  __IO uint32_t  SR;                                /*!< LED STATUS Register                                                   */
  __IO uint32_t  CON2;                              /*!< LED Control Register2                                                 */
  __IO uint32_t  CON1;                              /*!< LED Control Register1                                                 */
  __I  uint32_t  RESERVED1;
  __IO uint32_t  DISPRAM0;                          /*!< LED Display data 0                                                    */
  __IO uint32_t  DISPRAM1;                          /*!< LED Display data 1                                                    */
  __IO uint32_t  DISPRAM2;                          /*!< LED Display data 2                                                    */
  __IO uint32_t  DISPRAM3;                          /*!< LED Display data 3                                                    */
  __IO uint32_t  DISPRAM4;                          /*!< LED Display data 4                                                    */
  __IO uint32_t  DISPRAM5;                          /*!< LED Display data 5                                                    */
  __IO uint32_t  DISPRAM6;                          /*!< LED Display data 6                                                    */
  __IO uint32_t  DISPRAM7;                          /*!< LED Display data 7                                                    */
  __IO uint32_t  DISPRAM8;                          /*!< LED Display data 8                                                    */
  __IO uint32_t  DISPRAM9;                          /*!< LED Display data 9                                                    */
  __IO uint32_t  DISPRAM10;                         /*!< LED Display data 10                                                   */
  __IO uint32_t  DISPRAM11;                         /*!< LED Display data 11                                                   */
  __IO uint32_t  DISPRAM12;                         /*!< LED Display data 12                                                   */
  __IO uint32_t  DISPRAM13;                         /*!< LED Display data 13                                                   */
  __IO uint32_t  DISPRAM14;                         /*!< LED Display data 14                                                   */
  __IO uint32_t  DISPRAM15;                         /*!< LED Display data 15                                                   */
} LED_Type;
...
#define UART_IDTR_WAITVAL_Msk                 (0x03UL << UART_IDTR_WAITVAL_Pos)                       /*!< UART IDTR: WAITVAL Mask                 */
...
#define LED_COMOE_COMOE13_Pos                 13                                                      /*!< LED COMOE: COMOE13 Position             */
#define LED_COMOE_COMOE13_Msk                 (0x01UL << LED_COMOE_COMOE13_Pos)                       /*!< LED COMOE: COMOE13 Mask                 */
#define LED_COMOE_COMOE14_Pos                 14                                                      /*!< LED COMOE: COMOE14 Position             */
#define LED_COMOE_COMOE14_Msk                 (0x01UL << LED_COMOE_COMOE14_Pos)                       /*!< LED COMOE: COMOE14 Mask                 */
#define LED_COMOE_COMOE15_Pos                 15                                                      /*!< LED COMOE: COMOE15 Position             */
#define LED_COMOE_COMOE15_Msk                 (0x01UL << LED_COMOE_COMOE15_Pos)                       /*!< LED COMOE: COMOE15 Mask                 */
