/**
 *******************************************************************************
 * @file        debug_a31g31x.h
 * @author      ABOV R&D Division
 * @brief       A31G31x debug config file
 *
...
#ifndef _DEBUG_A31G31X_H_
#define _DEBUG_A31G31X_H_
...
/* Forcibly, configured as a UART1 in order for testing LED module */
#if (CONFIG_HAL_LED == 1)
...
#define DEBUG_TX_ALT_ID                  1
#if (CONFIG_IRQ_26 != 0)
#warning Should change CONFIG_IRQ_26 value to 0 in config_a31g31x.h.
#endif
...
#define DEBUG_TX_ALT_ID                  1
#if (CONFIG_IRQ_26 != 1)
#warning Should change CONFIG_IRQ_26 value to 1 in config_a31g31x.h.
#endif
...
#endif /* CONFIG_HAL_LED */

#endif /* _DEBUG_A31G31X_H_ */
