/**
 *******************************************************************************
 * @file        debug_a31g32x.h
 * @author      ABOV R&D Division
 * @brief       A31G32x debug config file
 *
...
#ifndef _DEBUG_A31G32X_H_
#define _DEBUG_A31G32X_H_
...
/* Forcibly, configured as a USART1 in order for testing EBI module */
#if (CONFIG_HAL_EBI == 1)
...
#define DEBUG_RX_ALT_ID                  0
#define DEBUG_TX_PORT_ID                 2
#define DEBUG_TX_ALT_ID                  0
#else
...
#else
#error Only USART module as a debug log can be used.
#endif

#endif /* CONFIG_HAL_EBI */

#endif /* _DEBUG_A31G32X_H_ */
