/**
 *******************************************************************************
 * @file        debug_a31l22x.h
 * @author      ABOV R&D Division
 * @brief       A31L22x debug config file
 *
