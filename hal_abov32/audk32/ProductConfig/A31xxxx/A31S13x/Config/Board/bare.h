 ...
 * @brief       Board configuration on which A31G11x is mounted
 *
...
#define LCD0_SEG5_PORT              3    /* Port D */
#define LCD0_SEG5_PORT_ID           7
#define LCD0_SEG5_MUX_ID            0
#define LCD0_SEG6_PORT              3    /* Port D */
