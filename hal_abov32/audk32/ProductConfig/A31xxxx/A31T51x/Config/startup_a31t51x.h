/**
 *******************************************************************************
 * @file        startup_a31t51x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A31T51x
 *
...
#ifndef _STARTUP_A31T51X_H_
#define _STARTUP_A31T51X_H_
...
{
    if(CHIPCONFIG->CHIPID == 0x54315180)
    {
        return (int8_t *)"A31T518 : Code Flash 512KB / SRAM 64KB";
    }
    else
    {
        return (int8_t *)"Unknown";
