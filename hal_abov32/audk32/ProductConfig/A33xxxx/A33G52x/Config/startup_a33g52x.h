/**
 *******************************************************************************
 * @file        startup_a33g52x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A33G52x
 *
...
#ifndef _STARTUP_A33G52X_H_
#define _STARTUP_A33G52X_H_
...
RAMFUNC static __inline CONFIG_FLASH_INFO_t PRV_CHIPSET_GetFlashGeometricInfo(void)
{
    ...
    tFlashGeometricInfo.tCflash.un8NumWProtectedBlocks = 3;
