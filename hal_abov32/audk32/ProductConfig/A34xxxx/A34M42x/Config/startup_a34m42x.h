/**
 *******************************************************************************
 * @file        startup_a34m42x.h
 * @author      ABOV R&D Division
 * @brief       Startup APIs for A34M42x
 *
...
#ifndef _STARTUP_A34M42X_H_
#define _STARTUP_A34M42X_H_
...
{
    if(CHIPCONFIG->CHIPID == 0x4D344200)
    {
        return (int8_t *)"A34M420 : Flash 1024KB / SRAM 64KB";
    }
    else
    {
        return (int8_t *)"Unknown";
...
RAMFUNC static __inline CONFIG_FLASH_INFO_t PRV_CHIPSET_GetFlashGeometricInfo(void)
{
    ...
    {
        case 0x4D344200: /* A34M420 */
            tFlashGeometricInfo.tCflash.un32Size = 0x100000;
            tFlashGeometricInfo.tCflash.un8NumWProtectedBlocks = 2;
            tFlashGeometricInfo.tCflash.tWProtectedBlocks[1].un32WProtectedSegStartOffset = 0x80000;
            tFlashGeometricInfo.tCflash.tWProtectedBlocks[1].un32WProtectedSegSize = 0x8000;
            tFlashGeometricInfo.tCflash.tWProtectedBlocks[1].un8NumWProtectedSegs = 16;
            break;
...
static __inline void PRV_PORT_Init(void)
{
    ...
    PA->MR1 = 0x00UL
            | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7 - 0:PA7 1: 2:T3IO 3:CAPEW 7:AN7 */
            | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6 - 0:PA6 1: 2:T2IO 3:CAPEV 7:AN6 */
            | (0x00UL << PCU_MR1_P5MUX_Pos)    /* P5 - 0:PA5 1: 2:T1IO 3:CAPEU 7:AN5 */
            | (0x00UL << PCU_MR1_P4MUX_Pos)    /* P4 - 0:PA4 1: 2:T0IO 3:      7:AN4 */
    ...
    PA->MR2 = 0x00UL
            | (0x00UL << PCU_MR2_P15MUX_Pos)   /* P15 - 0:PA15 1:MISO0 2: 3:OVINEV  7:AN15 */
            | (0x00UL << PCU_MR2_P14MUX_Pos)   /* P14 - 0:PA14 1:MOSI0 2: 3:PRTINEV 7:AN14 */
            | (0x00UL << PCU_MR2_P13MUX_Pos)   /* P13 - 0:PA13 1:SCK0  2: 3:        7:AN13 */
            | (0x00UL << PCU_MR2_P12MUX_Pos)   /* P12 - 0:PA12 1:SS0   2: 3:SCAPEW  7:AN12 */
            | (0x00UL << PCU_MR2_P11MUX_Pos)   /* P11 - 0:PA11 1:TXD1  2: 3:SCAPEV  7:AN11 */
            | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:PA10 1:RXD1  2: 3:SCAPEU  7:AN10 */
            | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PA9  1:      2: 3:        7:AN9  */
            | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PA8  1:      2: 3:        7:AN8  */
    ...
    PC->MR2 = 0x00UL
            | (0x00UL << PCU_MR2_P15MUX_Pos)   /* P15 - 0:PC15 1:MISO0 2:     3:TXD0   7: */
            | (0x00UL << PCU_MR2_P14MUX_Pos)   /* P14 - 0:PC14 1:MOSI0 2:     3:RXD0   7: */
    ...
    PD->MR2 = 0x00UL
            | (0x00UL << PCU_MR2_P15MUX_Pos)   /* P15 - 0:PD15 1:SCK0 2:     3:      7: */
            | (0x00UL << PCU_MR2_P14MUX_Pos)   /* P14 - 0:PD14 1:SS0  2:     3:      7: */
            | (0x00UL << PCU_MR2_P13MUX_Pos)   /* P13 - 0:PD13 1:     2:T3IO 3:      7: */
            | (0x00UL << PCU_MR2_P12MUX_Pos)   /* P12 - 0:PD12 1:     2:T2IO 3:      7: */
            | (0x00UL << PCU_MR2_P11MUX_Pos)   /* P11 - 0:PD11 1:     2:T1IO 3:      7: */
            | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:PD10 1:     2:T0IO 3:      7: */
    ...
    PE->MR1 = 0x00UL
            | (0x00UL << PCU_MR1_P7MUX_Pos)    /* P7 - 0:PE7 1:     2:T6IO 3: 7: */
            | (0x00UL << PCU_MR1_P6MUX_Pos)    /* P6 - 0:PE6 1:     2:T5IO 3: 7: */
            ...
            | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2 - 0:PE2 1:     2:     3: 7:AN21 */
            | (0x00UL << PCU_MR1_P1MUX_Pos)    /* P1 - 0:PE1 1:     2:     3: 7:AN20 */
    ...
    PE->MR2 = 0x00UL
            ...
            | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PE9  1:     2:T8IO 3: 7: */
            | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PE8  1:     2:T7IO 3: 7: */
    ...
    PF->MR1 = 0x00UL
            ...
            | (0x00UL << PCU_MR1_P3MUX_Pos)    /* P3 - 0:PF3 1:     2: 3:        7:AN23 */
            | (0x00UL << PCU_MR1_P2MUX_Pos)    /* P2 - 0:PF2 1:     2: 3:        7:AN22 */
    ...
    PG->MR2 = 0x00UL
            | (0x00UL << PCU_MR2_P10MUX_Pos)   /* P10 - 0:PG10 1:     2: 3: 7: */
            | (0x00UL << PCU_MR2_P9MUX_Pos)    /* P9  - 0:PG9  1:TXD3 2: 3: 7: */
            | (0x00UL << PCU_MR2_P8MUX_Pos);   /* P8  - 0:PG8  1:RXD3 2: 3: 7: */
